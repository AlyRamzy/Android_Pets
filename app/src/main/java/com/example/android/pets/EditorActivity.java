...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        if(CurrentPet==null) {
            ...
            Uri insert = getContentResolver().insert(PetEntry.CONTENT_URI, contentValues);
            if (insert != null)
        ...
        else
        {
            ...
            int update = getContentResolver().update(CurrentPet,contentValues,null,null);
            if (update != 0)
                Toast.makeText(this, "Update Pet Successful", Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(this, "Update Pet Faield ", Toast.LENGTH_SHORT).show();
